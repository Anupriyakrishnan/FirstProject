...
router.patch(
  "/productUnlist/:id",
  adminAuth,
  productController.productUnlisted
);
...
router.patch(
  "/coupon/toggle-list/:id",
  adminAuth,
  couponController.toggleListCoupon
);
...
router.post(
  "/edit-product-offer/:offerId",
  adminAuth,
  offerController.editProductOffer
);
router.put(
  "/edit-category-offer/:offerId",
  adminAuth,
