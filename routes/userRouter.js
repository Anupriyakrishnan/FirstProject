...
router.patch('/removeAddress/:addressId',userAuth,profileController.ensureAuthenticated,profileController.removeAddress)
router.put('/editAddress/:addressId',userAuth, profileController.ensureAuthenticated, profileController.editAddress);
router.get('/getAddress/:addressId', userAuth,profileController.ensureAuthenticated, profileController.getAddress);
...
router.get('/changeEmailOtp',userAuth, profileController.ensureAuthenticated, profileController.getChangeEmailOtpPage);
router.post('/verifyChangeEmailOtp',userAuth, profileController.verifyChangeEmailOtp);
router.post('/resendChangeEmailOtp',userAuth, profileController.resendChangeEmailOtp);
